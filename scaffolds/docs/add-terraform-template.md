...
_*STOP*: Before you proceed, make sure you review the [Naming Standards](../naming-conventions.md) guide to ensure your new template will adhere to the project standards_

1. Open this repository in your local IDE tool
2. Open a terminal in this local path to this directory
3. Choose a new name for this template. _Don't forget to review [Naming Standards](../naming-conventions.md) guide_
