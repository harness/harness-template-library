...
- FIX: ci-golden-pipeline to skip webhook type validation when branches configuration is set to 'skipped'

## [v2.6.7] - 2026-09-23

- ADD: Template default-images-manual-update
- UPDATE: sto-sast-register-repo template IDP Workflow to fix library path issues
